...
```
![](assets/example_gene_plot.png){width=400 height=350}
Isoform 1 has a changepoint at 67.5 min and is monotonic increasing concave (micv) shaped. 
Isoform 2 has no changepoint and is an unconstrained thinplate (tp) shape.
